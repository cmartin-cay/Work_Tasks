...
required_columns = ['PAMPortCode',	'PortNameAlt', 'PolarID', 'SumOfUnits', 'secname', 'SumOfMarket Value', 'PamPrice',
                    'FxShortName', 'AvgOfusfx', 'SumOfEnding Accrued', 'SumOfUnreal FX G/L Income']
